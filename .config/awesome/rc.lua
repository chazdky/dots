...
beautiful.bg_normal         = "#2d2b55"
beautiful.bg_focus          = "#2d2b55"
...
beautiful.font              = "Fira Mono Regular 12"
beautiful.notification_font = "Fira Code Retina 12"
...
mymainmenu = freedesktop.menu.build({
    ...
    after = {
        { "Awesome", myawesomemenu, "/usr/share/awesome/icons/awesomex32.png" },
